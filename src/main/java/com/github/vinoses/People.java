...
public class People
{
  ...
  /**
   * Delete a person from the set of smallCrowd people
  ...
  /**
   * Delete a person from the set of largeCrowd people
   * @param id The id of the person to delete
   */
  public String deletePersons(String id)
  {
    Person person = largeCrowd.remove(id);
    if (person == null)
    {
      return "Person does not exist";
    }
